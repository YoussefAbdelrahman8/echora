...
For specific data preparation and training process, please refer to: [Text Detection](../model_train/detection.en.md), [Text Recognition](../model_train/recognition.en.md), more functions such as predictive deployment,
