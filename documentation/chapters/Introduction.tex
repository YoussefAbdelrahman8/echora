...
Vision plays a fundamental role in human perception, enabling individuals to navigate environments, recognize objects, and interact safely with the physical world. For Blind and Low Vision (BLV) individuals, the absence or limitation of visual input significantly impacts mobility, independence, and confidence in daily activities. While traditional assistive tools such as white canes and guide dogs provide essential support, they offer limited environmental information and often rely on direct physical contact.

Recent advances in artificial intelligence (AI), machine learning, and wearable sensing technologies have enabled new forms of assistive systems that compensate for visual impairment through alternative sensory channels. Sensory substitution approaches transform visual and spatial information into auditory feedback, allowing users to perceive aspects of their surroundings without relying on vision. These systems aim to improve environmental awareness, enhance safety, and support independent interaction with objects and spaces.

Project \textbf{Echora} is proposed as an intelligent sensory substitution system that integrates AI-driven perception with multimodal sensing and real-time feedback. The system is designed to support both large-scale environmental navigation and fine-grained object interaction by translating spatial and semantic information into intuitive audio and haptic cues. By operating as an adaptive and context-aware digital sense, Echora seeks to move beyond single-purpose assistive devices toward a unified perceptual solution.
...
The Echora system is intended to assist Blind and Low Vision (BLV) users in navigating environments and interacting with physical objects in a safe and independent manner. The system is designed for everyday use in both indoor and outdoor settings, such as homes, workplaces, public buildings, and urban spaces.

Echora is expected to be worn and used continuously while the user is moving or performing tasks that require spatial awareness or object interaction. It provides real-time audio and haptic feedback to convey information about surroundings, obstacles, and points of interest, enabling users to make informed movement and interaction decisions without relying on visual input.

The system is intended to operate autonomously with minimal user intervention, adapting its behavior based on user context and activity. Echora is not designed to replace traditional mobility aids such as white canes or guide dogs but rather to complement them by providing additional environmental and interaction-related information.

\section{Project Overview}

Project Echora is an AI-powered sensory substitution system designed to assist Blind and Low Vision (BLV) users by translating environmental and object-related information into intuitive audio and haptic feedback. The system combines wearable sensing hardware with smartphone-based artificial intelligence to provide real-time perception of the user’s surroundings.

Echora operates through a multimodal approach that supports both large-scale environmental awareness and fine-grained object interaction. By integrating depth sensing, computer vision, active acoustic sensing, and haptic feedback, the system enables users to navigate spaces, locate objects, and interact with them more safely and confidently. The system is designed to adapt its feedback based on user context, allowing seamless transitions between navigation and interaction tasks.

The project emphasizes modularity and scalability, with computation performed on a mobile device to leverage modern AI capabilities while keeping wearable hardware lightweight. Echora is developed as an assistive system that complements existing mobility aids and aims to enhance user independence through a unified digital perception of the environment.

\section{Problem Statement}

Blind and Low Vision (BLV) individuals face significant challenges in navigating environments and interacting with physical objects due to the lack of visual information. While traditional mobility aids such as white canes and guide dogs provide essential support, they primarily rely on direct physical contact and offer limited awareness of the surrounding environment beyond immediate obstacles. As a result, users often lack advance information about spatial layout, object location, and object properties, which can lead to inefficiency, safety risks, and reduced independence.

Existing assistive technologies typically address isolated tasks, such as text recognition, basic obstacle detection, or audio-based scene description. These solutions often fail to provide continuous spatial awareness, precise guidance for object interaction, or an integrated understanding of the environment. Furthermore, most current systems do not support pre-contact perception of objects, forcing users to rely on trial-and-error touch when interacting with unfamiliar items.

Therefore, there is a need for an assistive system that can provide real-time, integrated spatial and semantic information to BLV users. Such a system should support both navigation and fine-grained object interaction while operating in everyday environments with minimal user effort and without replacing existing mobility aids.
...
Despite these challenges, many existing assistive technologies provide only partial support, often focusing on isolated tasks such as obstacle detection or text reading. Such solutions frequently lack integrated spatial awareness, real-time feedback, and support for fine-grained object interaction, limiting their effectiveness in complex real-world environments.

Echora is motivated by the need to address these gaps through an integrated, AI-powered sensory substitution system. By leveraging advances in artificial intelligence, wearable sensing, and mobile computing, Echora aims to translate spatial and semantic information into intuitive audio and haptic feedback. This approach seeks to reduce cognitive load, improve safety, and empower BLV users with a more comprehensive and proactive understanding of their surroundings, directly responding to the scale, trends, and impacts highlighted in Figures~\ref{fig:global_eye_conditions} through~\ref{fig:lossl_per_year}.

\newpage
\begin{figure}[H]
    \centering
    \includegraphics[width=1.1\textwidth]{assets/global_eye_conditions.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.1\textwidth]{assets/sight-loss-over-time Egypt.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.1\textwidth]{assets/productivity loss due to poor vision per year.png}
...
The Echora system follows a distributed architecture that separates sensing and actuation from computation and intelligence. The architecture is composed of two main components: wearable hardware and smartphone-based software.

The wearable system consists of smart glasses equipped with a depth camera for environmental sensing, an inertial measurement unit for motion and orientation tracking, haptic actuators positioned on the wrist to deliver tactile feedback, a low-power microcontroller responsible for sensor data acquisition and communication, and a rechargeable battery that powers the wearable components. These hardware elements are designed exclusively for sensing and feedback purposes, with no artificial intelligence or high-level decision-making performed on the wearable device itself.

The smartphone-based software serves as the central processing unit of the system. It performs real-time processing of depth and visual data, executes artificial intelligence models for spatial perception, object detection, hand tracking, and semantic understanding, manages navigation logic and automatic mode switching between navigation and interaction, generates spatial audio feedback, and issues haptic control commands to the wearable device. This separation allows the wearable hardware to remain lightweight while enabling scalable software upgrades without requiring hardware modifications.

\subsection{Communication Protocol}
\label{subsubsec:communication_protocol}

The Echora system employs wireless communication to support real-time data exchange between the wearable hardware and the smartphone software. The communication design prioritizes low latency, reliability, and power efficiency to support continuous operation.

A combination of Wi-Fi and Bluetooth Low Energy (BLE) is used to achieve this balance. Wi-Fi communication is utilized for transmitting high-bandwidth data such as depth frames and visual information, while BLE is used for low-bandwidth, low-power data exchange including sensor readings, control signals, and haptic commands. The wearable device transmits raw sensor data, including depth measurements and inertial data, to the smartphone for processing. In return, the smartphone sends control instructions to the wearable device, such as haptic feedback commands, mode changes, and warning signals. All communication is designed to operate in real time with minimal delay to ensure responsive and reliable user feedback.

\subsection{In-Scope Features}
\label{subsubsec:in_scope_features}

The scope of the Echora project includes real-time environmental awareness enabled through depth sensing, audio-based spatial feedback for navigation assistance, and haptic feedback for collision avoidance and hand guidance. The system also supports object and interaction target detection, such as doors, handles, and buttons, as well as automatic switching between navigation and interaction modes based on user context.

\subsection{Out-of-Scope Items}
\label{subsubsec:out_of_scope}

The project explicitly excludes the replacement of traditional mobility aids such as white canes or guide dogs. It does not support autonomous navigation or decision-making without user control, nor does it provide medical diagnosis or treatment functionality. Cloud-based processing and continuous internet dependency are excluded to ensure offline usability. Additionally, the project does not include long-term user training or rehabilitation programs.

\subsection{Supported Sustainable Development Goals (SDGs)}
\label{subsubsec:sdgs}

The Echora project supports several United Nations Sustainable Development Goals. It contributes to SDG~3 by enhancing safety, independence, and quality of life for Blind and Low Vision users. It aligns with SDG~9 through the application of innovative AI and wearable technologies in assistive systems. The project promotes SDG~10 by reducing inequalities through improved access to navigation and interaction in physical environments. Finally, it supports SDG~11 by enabling inclusive and accessible urban mobility without requiring changes to existing infrastructure.

\section{Objectives}
\label{subsec:objectives}

The objectives of the Echora project define the intended outcomes and guide the design and development process. The system aims to enhance environmental awareness by providing continuous real-time perception of surrounding spaces, support safe navigation in indoor and outdoor environments, and enable precise object interaction by guiding the user’s hand toward interaction targets. It seeks to integrate multimodal sensor data into a unified perception model and deliver intuitive audio and haptic feedback that is easy to interpret. The project emphasizes minimizing cognitive load through context-aware adaptation, ensuring real-time performance with low latency, and leveraging mobile computing to reduce hardware cost and improve scalability. The system is designed to maintain modularity for future extensions, complement existing mobility aids rather than replace them, and ultimately promote user independence and confidence.
...
From a technical perspective, the system must process multimodal sensor data in real time with minimal latency to ensure timely feedback. Sensor reliability remains a concern, as depth sensing and hand tracking accuracy can degrade in varying lighting conditions or cluttered environments. Designing effective audio and haptic feedback requires balancing informativeness with simplicity to avoid overwhelming the user. Wireless communication stability between wearable hardware and the smartphone is critical for responsiveness, and computational constraints on mobile devices may limit the simultaneous execution of multiple AI models.
...
\begin{table}[H]
\raggedright
\includegraphics[width=\textwidth]{assets/Risks.png}
...
\begin{table}[H]
\raggedright
\includegraphics[height=0.7\textwidth]{assets/echora_standards_table.png}
...
\begin{table}[H]
\raggedright
\includegraphics[height=0.8\textwidth]{assets/Constraints.png}
